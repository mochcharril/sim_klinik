...
class ReportController extends Controller
{
    ...
    public function listMedicine(){
        try {
            ...
            return view('clinic.pages.report.medicine-list', $this->param);
        } catch (\Exception $e) {
    ...
    public function printMedicine(){
        try {
            $this->param['getMedicine'] = Medicine::all();
            $pdf = PDF::loadview('clinic.pages.report.medicine-print', $this->param)->setPaper('legal', 'landscape');
    ...
    public function listMedicineIncoming(){
        try {
            ...
            return view('clinic.pages.report.medicine-incoming-list', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function printMedicineIncoming(){
        try {
            $this->param['getMedicineIncoming'] = \DB::table('incoming_medicine_details')
                                                        ...
                                                        ->join('medicines', 'incoming_medicine_details.medicine_id', 'medicines.id')
                                                        ->get();
            $pdf = PDF::loadview('clinic.pages.report.medicine-incoming-print', $this->param)->setPaper('legal', 'landscape');
    ...
    public function listCheckup(){
        try {
            ...
            return view('clinic.pages.report.checkups-list', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function printCheckup(){
        try {
            ...
            $pdf = PDF::loadview('clinic.pages.report.checkups-print', $this->param)->setPaper('legal', 'landscape');
            return $pdf->stream('cetak-laporan-pdf-obat-masuk', array("Attachment" => false));
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
    ...
    public function listPatient(){
        try {
            ...
            return view('clinic.pages.report.patient-list', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function printPatient(){
        try {
            $this->param['register_as'] = 'no';
            $this->param['getPatient'] = Patient::all();
            $pdf = PDF::loadview('clinic.pages.report.patient-print', $this->param)->setPaper('legal', 'landscape');
            return $pdf->stream('cetak-laporan-pdf-pasien', array("Attachment" => false));
            return view('clinic.pages.report.patient-print', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function listRecipe(){
        try {
            ...
            return view('clinic.pages.report.recipe-list', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function printRecipe(){
        try {
            ...
            $pdf = PDF::loadview('clinic.pages.report.recipe-print', $this->param)->setPaper('legal', 'landscape');
            return $pdf->stream('cetak-laporan-pdf-obat-masuk', array("Attachment" => false));
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
    ...
    public function listPayment(){
        try {
            ...
            return view('clinic.pages.report.payment-list', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function printPayment(){
        try {
            ...
            $pdf = PDF::loadview('clinic.pages.report.payment-print', $this->param)->setPaper('legal', 'landscape');
            return $pdf->stream('cetak-laporan-pdf-obat-masuk', array("Attachment" => false));
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
    ...
    public function listTopSick(){
        try {
            ...
            return view('clinic.pages.report.top-sick-list', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function printTopSick(){
        try {
            $this->param['getTopSick'] = \DB::table('checkups')
                                            ...
                                            ->orderByDesc('total')
                                            ->get();
            $pdf = PDF::loadview('clinic.pages.report.top-sick-print', $this->param)->setPaper('legal', 'landscape');
