...
class PaymentController extends Controller
{
    ...
    public function index(){
        try {
            ...
            return view('pharmacist.pages.payment.list', $this->param);
        } catch (\Exception $e) {
    ...
    public function add(Checkup $checkup){
        try {
            ...
            return view('pharmacist.pages.payment.add', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function detail(Checkup $checkup){
        try {
            ...
            return view('pharmacist.pages.payment.detail', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
