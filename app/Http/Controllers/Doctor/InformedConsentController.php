...
class InformedConsentController extends Controller
{
    ...
    public function agreementForm(Checkup $checkup){
        ...
        $pdf = PDF::loadview('doctor.pages.informed-consent.print-agreement-form', $this->param)->setPaper('legal');
    ...
    public function rejectionForm(Checkup $checkup){
        ...
        $pdf = PDF::loadview('doctor.pages.informed-consent.print-rejection-form', $this->param)->setPaper('legal');
