...
class CheckupController extends Controller
{
    ...
    public function add(Patient $patient){
        try {
            ...
            return view('doctor.pages.checkup.add', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function addNurse(Checkup $checkup){
        try {
            ...
            return view('doctor.pages.checkup.add-nurse', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function store(Patient $patient, Request $request)
    {
        ...
        try {
            ...
            return redirect('/doctor/action/checkup')->withStatus('Berhasil menambah data pemeriksaan.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
