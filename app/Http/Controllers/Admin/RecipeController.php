...
class RecipeController extends Controller
{
    ...
    public function add(Checkup $checkup){
        try {
            ...
            return view('admin.pages.recipe.add', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function store(Request $request, Checkup $checkup){
        ...
        try {
            ...
            return redirect('/admin/action/recipe')->withStatus('Berhasil menambahkan resep.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function detail(Checkup $checkup){
        try {
            ...
            return view('admin.pages.recipe.detail', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
