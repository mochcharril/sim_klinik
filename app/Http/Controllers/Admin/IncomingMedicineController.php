...
class IncomingMedicineController extends Controller
{
    ...
    public function add(){
        try {
            ...
            return view('admin.pages.incoming_medicine.add', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function store(Request $request){
        ...
        try {
            ...
            return redirect('/admin/warehouse/incoming_medicine')->withStatus('Berhasil menambahkan data obat masuk.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function detail(IncomingMedicine $incoming_medicine){
        try {
            ...
            return view('admin.pages.incoming_medicine.detail', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
