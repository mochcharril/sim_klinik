...
@section('content')
<div>
    <a href="{{url('/clinic/report-medicine/print')}}" class="bg-yellow-500 text-white rounded px-4 py-3 mt-2 hover:bg-yellow-600">Cetak PDF</a>
