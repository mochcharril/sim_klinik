...
<div>
    <div class="mb-8">
        <a href="{{url('/clinic/report-payment/print')}}" class="bg-blue-500 text-white rounded px-4 py-3 mt-2 hover:bg-blue-600">Cetak PDF (SEMUA)</a>
            ...
            <div id="form_code" style="display: none;">
                <form method="POST" action="{{url('/clinic/report-payment/code/print')}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-3">
                        ...
                        <select name="payment" id="payment" placholder="Pilih Kode Pembayaran..." class="form-input mt-1 p-3 border-2 @error('payment') border-red-500 @enderror focus:outline-none focus:border-blue-500 form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0">
