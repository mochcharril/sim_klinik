...
<div>
    <div class="mb-8">
        <a href="{{url('/clinic/report-patient/print')}}" class="bg-yellow-500 text-white rounded px-4 py-3 mt-2 hover:bg-yellow-600">Cetak PDF (SEMUA)</a>
        <a href="{{url('/clinic/report-patient')}}" class="bg-orange-500 text-white rounded px-4 py-3 mt-2 hover:bg-orange-600">Reset Filter</a>
    </div>
    <div class="card mb-8">
        ...
        <div class="card-body">
            ...
            <div id="form_as" style="display: none;">
                <form method="POST" action="{{url('/clinic/report-patient/as/print')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-3">
