...
@section('content')
<div>
    <a href="{{url('/admin/master-data/doctor/add')}}" class="text-white rounded px-4 py-3 mt-2" style="background-color: #609966;">Tambah Data</a>
    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white bg-opacity-90">
        <div class="text-bold pb-5">
            <b class="text-bold text-black">DATA DOKTER</b>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left t-mx-3 flex">
                        <form action="{{url('/admin/master-data/doctor')}}/{{$item->id}}/edit" method="POST" class="m-auto">
                            @csrf
                        ...
                        <form action="{{url('/admin/master-data/doctor')}}/{{$item->id}}/drop" method="POST" class="m-auto">
                            @method('delete')
                            @csrf
