...
<div>
    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white bg-opacity-90">
        <div class="text-bold pb-5">
            <b class="text-bold text-black">Persetujuan Tindakan Disetujui</b>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left t-mx-3 flex">
                        <form action="{{url('/admin/informed-consent/agreement-form')}}/{{$item->id}}" method="GET" class="m-auto">
...
<div>
    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white bg-opacity-90">
        <div class="text-bold pb-5">
            <b class="text-bold text-black">Persetujuan Tindakan Ditolak</b>
        </div>
        <table id="thisTables" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left">{{$item->other_notes}}</td>
                    <td class="text-left t-mx-3 flex">
                        <form action="{{url('/admin/informed-consent/rejection-form')}}/{{$item->id}}" method="GET" class="m-auto">
