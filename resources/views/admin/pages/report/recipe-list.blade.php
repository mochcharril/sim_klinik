    ...
    <div class="card mb-8">
        ...
        <div class="card-body">
            ...
            <div id="form_date" style="display: none;">
                <form method="POST" action="{{url('/admin/report-recipe/date/print')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-3">
            ...
            <div id="form_code" style="display: none;">
                <form method="POST" action="{{url('/admin/report-recipe/code/print')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-3">
