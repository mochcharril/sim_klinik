...
@section('content')
<div>
    <a href="{{url('/admin/master-data/medicine_rule/add')}}" class="text-white rounded px-4 py-3 mt-2" style="background-color: #609966;"">Tambah Data</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left t-mx-3 flex">
                        <form action="{{url('/admin/master-data/medicine_rule')}}/{{$item->id}}/edit" method="POST" class="m-auto">
                            @csrf
                        ...
                        <form action="{{url('/admin/master-data/medicine_rule')}}/{{$item->id}}/drop" method="POST" class="m-auto">
                            @method('delete')
                            @csrf
