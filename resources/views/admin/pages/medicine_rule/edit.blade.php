        ...
        <div class="card-body">
            <form method="POST" action="{{url('/admin/master-data/medicine_rule/update',$getDetailMedicineRule->id)}}" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="name" class="form-input w-full block rounded mt-1 p-3 border-2 @error('name') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Nama Aturan Pakai Obat" value="{{old('name', $getDetailMedicineRule->name)}}">
                    @error('name')
