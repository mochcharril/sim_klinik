        ...
        <div class="card-body">
            <form method="POST" action="{{url('/admin/master-data/pharmacist/update', $getDetailPharmacist->id)}}" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="name" class="form-input w-full block rounded mt-1 p-3 border-2 @error('name') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Nama Apoteker" value="{{old('name', $getDetailPharmacist->name)}}">
                    @error('name')
                ...
                <div class="mt-3">
                    ...
                    <input type="email" name="email" class="form-input w-full block rounded mt-1 p-3 border-2 @error('email') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Surel Apoteker" value="{{old('email', $getDetailPharmacist->email)}}">
                    @error('email')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
