        ...
        <div class="card-body">
            <form method="POST" action="{{url('/admin/master-data/patient/store')}}" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="text" name="code_rm" class="form-input w-full block rounded mt-1 p-3 border-2 @error('code_rm') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Kode RM" value="{{$getCodeRM}}" readonly>
                    @error('code_rm')
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="name" class="form-input w-full block rounded mt-1 p-3 border-2 @error('name') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Nama Pasien" value="{{old('name')}}">
                    @error('name')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="nik" class="form-input w-full block rounded mt-1 p-3 border-2 @error('nik') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="NIK Pasien" value="{{old('nik')}}">
                    @error('nik')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div id="form_open_mhs" style="display: none;">
                    <div class="mt-3">
                        ...
                        <input type="text" name="nim_nip" class="form-input w-full block rounded mt-1 p-3 border-2 @error('nim_nip') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="NIM Mahasiswa" value="{{old('nim_nip')}}">
                        @error('nim_nip')
                        <span class="pl-1 text-xs text-red-600 text-bold">
                            {{$message}}
                        </span>
                ...
                <div id="form_open_kry" style="display: none;">
                    <div class="mt-3">
                        ...
                        <input type="text" name="nim_nip_karyawan" class="form-input w-full block rounded mt-1 p-3 border-2 @error('nim_nip_karyawan') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="NIP Karyawan" value="{{old('nim_nip_karyawan')}}">
                ...
                <div id="form_open_klg" style="display: none;">
                    <div class="mt-3">
                        ...
                        <input type="text" name="family_from" class="form-input w-full block rounded mt-1 p-3 border-2 @error('family_from') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Nama Karyawan" value="{{old('family_from')}}">
                        @error('family_from')
                        <span class="pl-1 text-xs text-red-600 text-bold">
                            {{$message}}
                        </span>
                    ...
                    <div class="mt-3">
                        <label class="text-gray-700 ml-1">NIP Karyawan : </label>
                        <input type="text" name="nim_nip_keluarga" class="form-input w-full block rounded mt-1 p-3 border-2 @error('nim_nip_keluarga') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="NIP Karyawan" value="{{old('nim_nip_keluarga')}}">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="place_of_birth" class="form-input w-full block rounded mt-1 p-3 border-2 @error('place_of_birth') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Tempat Lahir" value="{{old('place_of_birth')}}">
                ...
                <div class="mt-3">
                    ...
                    <input type="date" name="date_of_birth" class="form-input w-full block rounded mt-1 p-3 border-2 @error('date_of_birth') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Tanggal Lahir" value="{{old('date_of_birth')}}">
                    @error('date_of_birth')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="address" class="form-input w-full block rounded mt-1 p-3 border-2 @error('address') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Alamat" value="{{old('address')}}">
                    @error('address')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="phone_number" class="form-input w-full block rounded mt-1 p-3 border-2 @error('phone_number') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Nomor Telepon" value="{{old('phone_number')}}">
                    @error('phone_number')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div id="form_open" style="display:none;">
                    <div class="mt-3">
                        ...
                        <input type="text" id="insurance_type" name="insurance_type" class="form-input w-full block rounded mt-1 p-3 border-2 @error('insurance_type') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Jenis Asuransi" value="{{old('insurance_type')}}">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" id="insurance_number" name="insurance_number" class="form-input w-full block rounded mt-1 p-3 border-2 @error('insurance_number') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Nomor Asuransi" value="{{old('insurance_number')}}">
