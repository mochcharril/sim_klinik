        ...
        <div class="card-body">
            <form method="POST" action="{{url('/admin/master-data/admition/store')}}" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="name" class="form-input w-full block rounded mt-1 p-3 border-2 @error('name') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Nama Admisi" value="{{old('name')}}">
                    @error('name')
                ...
                <div class="mt-3">
                    ...
                    <input type="email" name="email" class="form-input w-full block rounded mt-1 p-3 border-2 @error('email') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Surel Admisi" value="{{old('email')}}">
                    @error('email')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
