            ...
            <div class="grid mt-5 grid-cols-2 gap-5 xl:grid-cols-1">
                ...
                <div class="grid grid-cols-1 mt-5 gap-5 xl:grid-cols-1">
                    <div>
                        ...
                        <input type="text" name="other_notes" class="form-input w-full block rounded mt-1 p-3 border-2 @error('other_notes') border-red-500 @enderror focus:outline-none focus:border-green-500" placeholder="Catatan" value="{{$getDetailCheckup->other_notes}}" readonly>
                        @error('other_notes')
                        <span class="pl-1 text-xs text-red-600 text-bold">
                            {{$message}}
                        </span>
