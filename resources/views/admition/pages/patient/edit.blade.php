...
<div>
    <div class="card mb-8">
        ...
        <div class="card-body">
            <form method="POST" action="{{url('/admition/master-data/patient/update',$getDetailPatient->id)}}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="name" class="form-input w-full block rounded mt-1 p-3 border-2 @error('name') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Nama Pasien" value="{{old('name', $getDetailPatient->name)}}">
                    @error('name')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="nik" class="form-input w-full block rounded mt-1 p-3 border-2 @error('nik') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="NIK Pasien" value="{{old('nik', $getDetailPatient->nik)}}">
                    @error('nik')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="place_of_birth" class="form-input w-full block rounded mt-1 p-3 border-2 @error('place_of_birth') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Tempat Lahir" value="{{old('place_of_birth', $getDetailPatient->place_of_birth)}}">
                ...
                <div class="mt-3">
                    ...
                    <input type="date" name="date_of_birth" class="form-input w-full block rounded mt-1 p-3 border-2 @error('date_of_birth') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Tanggal Lahir" value="{{old('date_of_birth', $getDetailPatient->date_of_birth)}}">
                    @error('date_of_birth')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="address" class="form-input w-full block rounded mt-1 p-3 border-2 @error('address') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Alamat" value="{{old('address', $getDetailPatient->address)}}">
                    @error('address')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="phone_number" class="form-input w-full block rounded mt-1 p-3 border-2 @error('phone_number') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Nomor Telepon" value="{{old('phone_number', $getDetailPatient->phone_number)}}">
                    @error('phone_number')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="insurance_type" class="form-input w-full block rounded mt-1 p-3 border-2 @error('insurance_type') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Jenis Asuransi" value="{{old('insurance_type', $getDetailPatient->insurance_type)}}">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="insurance_number" class="form-input w-full block rounded mt-1 p-3 border-2 @error('insurance_number') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Nomor Asuransi" value="{{old('insurance_number', $getDetailPatient->insurance_number)}}">
