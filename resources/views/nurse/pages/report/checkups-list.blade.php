...
<div>
    <div class="mb-8">
        <a href="{{url('/nurse/report-checkup/print')}}" class="text-white rounded px-4 py-3 mt-2" style="background-color: #609966">Cetak PDF (SEMUA)</a>
        <a href="{{url('/nurse/report-checkup')}}" class="bg-orange-500 text-white rounded px-4 py-3 mt-2 hover:bg-orange-600">Reset Filter</a>
    </div>
    ...
    <div class="card mb-8">
        ...
        <div class="card-body">
            ...
            <div id="form_date" style="display: none;">
                <form method="POST" action="{{url('/nurse/report-checkup/date/print')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-3">
            ...
            <div id="form_code" style="display: none;">
                <form method="POST" action="{{url('/nurse/report-checkup/code/print')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-3">
            ...
            <div id="form_as" style="display: none;">
                <form method="POST" action="{{url('/nurse/report-checkup/as/print')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-3">
