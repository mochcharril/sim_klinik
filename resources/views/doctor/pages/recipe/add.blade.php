    ...
    <div>
        <div class="card mb-8">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <input id="stock-1" type="hidden" name="stock[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('stock[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Stok Sisa">
                    @error('stock[]')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input id="stocks-1" type="text" name="stocks[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('stocks[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Stok Sisa" readonly>
                    @error('stocks[]')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
