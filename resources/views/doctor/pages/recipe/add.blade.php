...
@endsection
@section('content')
<form method="POST" action="{{url('/doctor/action/recipe/store',$getDetailCheckup->id)}}">
    @csrf
    <div>
        <div class="card mb-8">
            ...
            <div class="card-body">
                <div class="grid mt-5 grid-cols-2 gap-5 xl:grid-cols-1">
                    ...
                    <div>
                        ...
                        <input required type="text" name="code_rp" class="form-input w-full block rounded mt-1 p-3 border-2 @error('code_rp') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Kode Resep" value="{{$generateCodeRP}}" readonly>
                        @error('code_rp')
                        <span class="pl-1 text-xs text-red-600 text-bold">
                            {{$message}}
                        </span>
                    ...
                    <div>
                        ...
                        <input required type="date" name="date_recipe" class="form-input w-full block rounded mt-1 p-3 border-2 @error('date_recipe') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Tanggal Pemberian Resep">
                        @error('date_recipe')
                        <span class="pl-1 text-xs text-red-600 text-bold">
                            {{$message}}
                        </span>
                ...
                <div class="mt-5 flex justify-between">
                    <button type="button" class="btn-shadow bg-blue-500 text-white rounded px-10 py-2 mt-2 hover:bg-blue-600" onclick="panel_fields()">Tambah</button>
        ...
        <div class="card mb-8">
            <div class="card-body">
                <div class="mt-3">
                    ...
                    <select onchange="openMedicine(this, 1);" id="medicine" placeholder="Pilih Obat..." name="medicine[]" class="form-input mt-1 p-3 border-2 @error('medicine[]') border-red-500 @enderror focus:outline-none focus:border-blue-500 form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0">
                ...
                <div class="mt-3">
                    ...
                    <input id="price-1" type="text" name="price[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('price[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Harga">
                    @error('price[]')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input id="stock-1" type="text" name="stock[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('stock[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Stok Sisa">
                    @error('stock[]')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input id="stock_out-1" type="text" name="stock_out[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('stock_out[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Stok Keluar">
                    @error('stock_out[]')
                    <span class="pl-1 text-xs text-red-600 text-bold">
                        {{$message}}
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <select placeholder="Pilih Aturan Pakai..." name="medication_rules[]" class="form-input mt-1 p-3 border-2 @error('medication_rules[]') border-red-500 @enderror focus:outline-none focus:border-blue-500 form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0">
...
<script>
    ...
    function panel_fields(){
        ...
        divtest.innerHTML = '<div class="card mb-8"><div class="card-body"><div class="mt-3"><label class="text-gray-700 ml-1">Pilih Obat :</label><select onchange="openMedicine(this,1)" id="medicine" placeholder="Pilih Obat..." name="medicine[]" class="form-input mt-1 p-3 border-2 @error('medicine[]') border-red-500 @enderror focus:outline-none focus:border-blue-500 form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0"><option value="">Pilih Obat</option>@foreach ($getMedicine as $itemMedicine)<option value="{{$itemMedicine->id}}">{{$itemMedicine->name}}</option>@endforeach</select>@error('medicine[]')<span class="pl-1 text-xs text-red-600 text-bold">{{$message}}</span>@enderror</div><div class="mt-3"><label class="text-gray-700 ml-1">Harga:</label><input id="price-1" type="text" name="price[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('price[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Harga"> @error('price[]')<span class="pl-1 text-xs text-red-600 text-bold">{{$message}}</span>@enderror</div><div class="mt-3"><label class="text-gray-700 ml-1">Stok Sisa:</label><input id="stock-1" type="text" name="stock[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('stock[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Stok Sisa"> @error('stock[]')<span class="pl-1 text-xs text-red-600 text-bold">{{$message}}</span>@enderror</div><div class="mt-3"><label class="text-gray-700 ml-1">Stok Keluar:</label><input id="stock_out-1" type="text" name="stock_out[]" class="form-input w-full block rounded mt-1 p-3 border-2 @error('stock_out[]') border-red-500 @enderror focus:outline-none focus:border-blue-500" placeholder="Stok Keluar"> @error('stock_out[]')<span class="pl-1 text-xs text-red-600 text-bold">{{$message}}</span>@enderror</div><div class="mt-3"><label class="text-gray-700 ml-1">Aturan Pakai:</label><select placeholder="Pilih Aturan Pakai..." name="medication_rules[]" class="form-input mt-1 p-3 border-2 @error('medication_rules[]') border-red-500 @enderror focus:outline-none focus:border-blue-500 form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0"><option value="">Pilih Aturan Pakai</option>@foreach ($getMedicineRule as $itemMedicineRule)<option value="{{$itemMedicineRule->id}}">{{$itemMedicineRule->name}}</option>@endforeach</select>@error('medication_rules[]')<span class="pl-1 text-xs text-red-600 text-bold">{{$message}}</span>@enderror</div><div class="mt-5 flex flex-row-reverse"><button type="button" class="btn-shadow bg-red-500 text-white rounded px-10 py-2 mt-2 hover:bg-red-600" onclick="remove_panel_fields('+room+')">Hapus</button></div></div></div>';
