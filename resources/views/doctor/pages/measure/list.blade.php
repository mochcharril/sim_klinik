...
@section('content')
<div>
    <a href="{{url('/doctor/master-data/measure/add')}}" class="text-white rounded px-4 py-3 mt-2" style="background-color: #609966";>Tambah Data</a>
        ...
        <table id="thisTable" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            <thead>
                <tr>
                    ...
                    <th data-priority="2">Nama Tindakan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left t-mx-3 flex">
                        <form action="{{url('/doctor/master-data/measure')}}/{{$item->id}}/edit" method="POST" class="m-auto">
                            @csrf
                        ...
                        <form action="{{url('/doctor/master-data/measure')}}/{{$item->id}}/drop" method="POST" class="m-auto">
                            @method('delete')
                            @csrf
